...
const MODEL_ALIAS_MAP = {
    ...
    // User-facing model names -> internal model names
    'claude-opus-4-5': 'claude-opus-4-5-thinking',
    'claude-sonnet-4-5': 'claude-sonnet-4-5',
    'claude-sonnet-4-5-thinking': 'claude-sonnet-4-5-thinking',
    'claude-opus-4-5-thinking': 'claude-opus-4-5-thinking',
    // Dated Claude model versions -> internal model names
    'claude-opus-4-5-20251101': 'claude-opus-4-5-thinking',
    'claude-sonnet-4-5-20250929': 'claude-sonnet-4-5',
    'claude-haiku-4-5-20251001': 'gemini-3-flash'
};

// 真实模型名 -> 别名 (used to populate availableModels from API response)
const MODEL_NAME_MAP = {
    ...
    // Map internal Claude model names to user-facing names (without gemini- prefix)
    'claude-sonnet-4-5': 'claude-sonnet-4-5',
    'claude-sonnet-4-5-thinking': 'claude-sonnet-4-5-thinking',
